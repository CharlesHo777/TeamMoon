# ActiveAdmin.register EmailNotifier, namespace: :coord do
#
...
#   #
#   permit_params :template, :participant_id
#   #
#   # or
#   #
#   # permit_params do
...
#       redirect_to '/coord/email_notifiers'
#     end
#   end
#   controller do
#     def create
...
#     column :user
#     column "Email" do |obj|
#       link_to('Resend Email', resend_email_coord_email_notifiers_path(notifier: obj), format: :html	)
#     end
#     actions
#   end
#
